...
🔗 **Demonstração Online:** [Clique aqui para acessar](https://tasks-vue-uzgz.vercel.app)

Um dashboard interativo desenvolvido com **Vue.js 3** e **Vite**...

## 🚀 Funcionalidades Principais

* **Gerenciador de Tarefas:** Sistema completo de To-Do com adição de tarefas, marcação de concluídas e validação de campos.
...
1. Clone o repositório:
   ```bash
   git clone [https://github.com/Lucas-715/Tasks-Vue.git](https://github.com/Lucas-715/Tasks-Vue.git)
   ```
